...
class SurfaceEffects:
    ...
    def fade_to_black_and_back(screen: pygame.Surface) -> None:
        ...
        SurfaceEffects.fade_out(screen, background_surface, fade_surface)
        SurfaceEffects.fade_in(screen, background_surface, fade_surface)
